...
public class Road extends WorldObject {
	...
	/*
	 *TODO: részeltesebb leíró implementáció kidolgozása,
	 *az enum kevés
	 *
	 *meg kell adni az út síkbeli viszonítási pontján túl az út belső viszonyítási pontjait, pl felező vonal közepe
	 * 
	 */
	...
	public Road(int x, int y, float rotation, int width, int height, String imageFileName, boolean pedestrianCrossing, RoadType roadType) {
