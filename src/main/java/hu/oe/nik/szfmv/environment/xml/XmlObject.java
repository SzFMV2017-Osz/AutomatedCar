...
public class XmlObject {
     ...
     * IMPORTANT: 0° is horizontal right
     * 
     * @return
     */
    ...
    /**
     * Applying builder pattern to build XmlObject with:
     * - transformed rotation in degrees
     * - type checked DOM objects
     * 
    ...
    public static class XmlObjectBuilder{
    		 ...
    		 * 
    		 * @throws IllegalArgumentException if cannoit convert type attribute to enum
    		 * 
    		 * @param type
    		 * @return
    		 */
       	...
       	/**
    		...
    		public XmlObjectBuilder rotation(double[][] rotation) {
    			instance.rotation = Utils.radianToDegree(Utils.convertMatrixToRadians(rotation));
    			rotationSet = true;
    			log.info("setting rotation from {{"+rotation[0][0]+","+rotation[0][1]+"},{"+rotation[1][0]+","+rotation[1][1]+"}} to "+ instance.rotation);
    			return this;
    		}
