...
public abstract class MovingObject extends CollidableObject implements IRadarSensor {
    ...
    /**
     * change currentspeed to the resultants of currentspeed and the given
     * vectors
     *
     * @param vectors
     */
    ...
    /**
     * @deprecated set the objects rotation via the
     * {@link #changeDirection(Vector2D vector)} method
     *
     * @param angle
     */
    @Deprecated
