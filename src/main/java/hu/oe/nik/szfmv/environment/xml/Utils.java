...
public class Utils {
    ...
    // Copied from
    // https://github.com/SzFMV2017-Tavasz/AutomatedCar/blob/master/src/main/java/hu/oe/nik/szfmv17t/environment/utils/XmlParser.java#L257
    public static double convertMatrixToRadians(double m11, double m12, double m21, double m22) {
        // formula of the angle between the two vectors: a * b = |a| * |b| *
        // cos(beta)
