...
public class Vector2D {
    ...
    /**
     * Scalar multiplication. Multiplies the specified vector with the given value. Method is mutable.
     *
    ...
    /**
     * Scalar division. Divides the vector with the given double value. Method is mutable.
     *
     * @param value - The divider number. Throws IllegalArgumentException when trying to divide with 0.
    ...
    /**
     * Returns with a unit vector pointing in the direction specified by the angle.
     *
     * @param angleRad The angle where the unit vector should point, given in radians.
     ...
     * Returns with a unit vector pointing in the direction specified by the angle.
     *
     * @param angleDeg The angle where the unit vector should point, given in degrees.
     * @return Unit vector pointing in the specified angle.
     */
     ...
     * @return Returns true, if the other object is also Vector2D and their coordinates match. Returns false otherwise.
     */
    @Override
