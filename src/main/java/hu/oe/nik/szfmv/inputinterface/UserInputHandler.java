...
public final class UserInputHandler extends SystemComponent implements KeyListener {
    ...
    public void keyPressed(KeyEvent userKeyPress) {
        ...
        if (this.pressedKeyCodes.contains(KeyEvent.VK_B)) {
            // TODO: megjelenítés...
            /*if(GameDisplayJPanel.isIsSensorDebugMode()) {
                GameDisplayJPanel.setIsSensorDebugMode(false);
            } else {
                GameDisplayJPanel.setIsSensorDebugMode(true);
            }*/
            GameDisplayJPanel.setIsSensorDebugMode(true);
            System.out.println("...");
        }
