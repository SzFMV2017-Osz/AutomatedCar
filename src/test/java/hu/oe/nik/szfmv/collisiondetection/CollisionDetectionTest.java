...
/**
 * Class to test collisions between <code>MovingObject</code>s and
 * <code>CollidableObject</code>s
 *
 * @author danijanos
 */
public class CollisionDetectionTest {
	...
	/**
	 * Determines whether or not this <code>CollidableObject</code> and the
	 * specified <code>WorldObject</code> intersect. Two objects intersect
	 ...
	 * and this <code>CollidableObject</code> intersect; <code>false</code>
	 * otherwise.
	 */
